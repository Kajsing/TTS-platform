...
active implementation goal. The article-switch/deletion incident takes priority.
U8 remains parked.
...
- Keep a chapter list/navigation and a visible paused reading position. Resolve
  the previously reported pause/completion viewport jumps as part of that work.
