...
- `python3 scripts/check_extension.py` verifies manifest references,
  ...
  boundaries, rejection of `web_accessible_resources` extension-page exposure,
  runtime localhost-only service URL validation, service-aware page character
  limit wiring, bounded high-watermark offscreen audio scheduling, local
