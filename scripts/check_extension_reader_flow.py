...
def _verify_extension_reader_contract() -> dict[str, object]:
    ...
    required_fragments = {
        ...
        "popup.js": [
            ...
            "formatPageCapture",
            "formatLongPageStatus",
            "formatPageStructure",
            "updateReaderActionState",
            "resolveReaderCapabilities",
            "resolveReaderBaseCapabilities",
            "applySourceTabGuard",
            "pageActionUnavailableTitle",
            "focusSourceTabUnavailableTitle",
            "canFocusSourceTab",
            ...
            "Long Page:",
            "Source Tab:",
            "automatic continuation active",
            "next continuation char",
            "Offscreen Ready:",
            "Last Event:",
        ],
        "background.js": [
            ...
            "Focused original page tab.",
            "resolvePageMaxChars",
            "const maxChars = await resolvePageMaxChars(config)",
            "getPageCapture(tab.id, maxChars",
            ...
            "sourceTabActive",
            "sourceTabMessage",
            "No original page tab is available for this page action.",
    ...
    return {
        ...
        "popup_long_page_status": True,
        "popup_state_aware_actions": True,
