...
def _check_source_shape(repo_root: Path) -> dict[str, object]:
    ...
    required = [
        ...
        reader_root / "src" / "TtsPlatform.Reader.Windows" / "LocalServiceProcessControl.cs",
        reader_root / "src" / "TtsPlatform.Reader.Application" / "LocalServiceCoordinator.cs",
        reader_root / "src" / "TtsPlatform.Reader.App" / "ServiceCenterWindow.xaml",
    ...
    workstation_usability_features = [
        ...
        "LocalServiceCommandHandler",
        "VerifyOwnerAsync",
        "ReserveMaintenanceAsync",
        "reservationValid()",
        "ProcessAncestry.IsDescendant",
        "OpenServiceCenterAsync",
        "DeleteDocumentAsync",
...
def _build_development_package(
    ...
    required = {
        ...
        "check_reader_remote_firewall.ps1",
